...
export class SubscriptionService {
  ...
  async createTrialSubscription(userId: string, plan: SubscriptionPlan): Promise<void> {
  ...
  async createSubscription(userId: string, plan: SubscriptionPlan, callBackUrl: string): Promise<string> {
    ...
    const isTrialUpgrade = existingSubscription?.status === 'trial';
