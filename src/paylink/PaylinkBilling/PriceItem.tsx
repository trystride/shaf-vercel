      ...
      <button
        ...
        className={`${
          isSubscribed
            ...
            : "bg-black hover:bg-zinc-800 dark:bg-white dark:hover:bg-zinc-100 dark:text-black"
        } mt-8 block w-full rounded-lg px-4 py-3 text-center text-white font-semibold transition-colors duration-200`}
