      ...
      <div className="container">
        <div className="w-full">
          <div className="wow fadeInUp mb-8 text-center md:mb-12 lg:mb-16">
            ...
            <p className="mx-auto mt-4 max-w-[600px] text-base text-body-color md:text-lg">
              Get started with our flexible pricing plans. Choose the plan that best suits your needs and scale as you grow.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-2 lg:grid-cols-3">
          {pricingData.map((price, index) => (
            ...
            >
              ...
              <p className="mb-7 text-base text-body-color">{price.description}</p>
              <div className="mb-8 border-b border-body-color border-opacity-10 pb-8 dark:border-white dark:border-opacity-10">
                <h5 className="mb-3 text-lg font-medium text-body-color">Features</h5>
                <ul className="space-y-4">
                  {price.includes.map((feature, featureIndex) => (
                    <li key={featureIndex} className="text-base text-body-color flex items-center">
                      <svg
                        width="8"
                        height="8"
                        viewBox="0 0 8 8"
