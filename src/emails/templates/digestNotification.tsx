...
export const generateDigestNotification = ({
  ...
  const groupedAnnouncements = announcements.reduce((acc, curr) => {
                ...
                (announcement) => `
                  <div class="announcement">
                    ...
                    <p style="color: #666; font-size: 12px; margin: 0;">
                      Published: ${format(new Date(announcement.date), "PPp")}
                    </p>
                    ${
                      announcement.url
                        ? `<a href="${announcement.url}" class="button">View Full Announcement</a>`
                        : ""
                    }
                  </div>
                `
